...
#### Обязательные тексты (Hard Canon)
1. **Экран входа**:
   - Кнопка: `🧭 Узнай Базу`
2. **Экран Базы**:
   - Текст: *"База — это обязательные правила и принципы системы. После ознакомления необходимо принять Базу, иначе доступ к системе не предоставляется."*
3. **Кнопки финала**:
   - `📜 Принимаю Базу` (переход к анкете)
   - `Отказаться` (блок доступа)
