...
✅ ДЕЛАЕТСЯ ПЕРЕД ЛЮБЫМИ МОДУЛЯМИ

(до Auth, Employees, вообще до всего)

 Разделение сервисов по контурам

 Secure Core не имеет выхода в интернет

 Отдельные docker-сети / VM / namespaces

 Явно зафиксированы trust boundaries

🚫 Запрещено:

общий docker network

curl из Secure Core

npm install / pip install в runtime
