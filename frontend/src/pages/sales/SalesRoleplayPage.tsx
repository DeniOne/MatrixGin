    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-64px)] flex flex-col">
            <div className="mb-6">
                ...
                <p className="text-[#717182] mt-1">Тренируйте навыки переговоров с AI-симулятором</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1 min-h-0">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col overflow-hidden">
                    <div className="p-4 border-b border-gray-100 bg-gray-50">
                        <h2 className="font-medium text-gray-900">Сценарии</h2>
                    </div>
                ...
                <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col overflow-hidden relative">
                    {activeScenario ? (
                        <>
                                    ...
                                    >
                                        <div className={`flex max-w-[80%] ${msg.sender === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
                                            ...
                                            <div className={`p-4 rounded-2xl shadow-sm ${msg.sender === 'user'
                                                ? 'bg-blue-600 text-[#030213] rounded-tr-none'
                                                : 'bg-white text-gray-800 border border-gray-100 rounded-tl-none'
                                                }`}>
                                                <p className="text-sm leading-relaxed">{msg.text}</p>
                                                <span className={`text-[10px] mt-1 block ${msg.sender === 'user' ? 'text-blue-200' : 'text-[#717182]'
                                                    }`}>
                            ...
                            <div className="p-6 bg-white border-t border-gray-100">
                                <div className="flex justify-center items-center space-x-8">
                                    <button className="p-3 rounded-full text-[#717182] hover:bg-gray-100 transition-colors">
                                    ...
                                    >
                                        {isRecording ? (
                                            <Square className="w-6 h-6 text-[#030213] fill-current" />
                                        ) : (
                                            <Mic className="w-8 h-8 text-[#030213]" />
                                        )}
                                    </button>
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-[#717182] p-8 text-center bg-gray-50/30">
                            ...
                            <h3 className="text-xl font-medium text-gray-900 mb-2">Выберите сценарий</h3>
                            <p className="max-w-md text-[#717182]">
                    ...
                    {/* Feedback Overlay */}
                    {feedback && (
                        <div className="absolute inset-0 bg-white/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in fade-in zoom-in duration-300">
                                ...
                                <h2 className="text-2xl font-medium text-center text-gray-900 mb-2">Тренировка завершена!</h2>
                                <p className="text-center text-gray-600 mb-6">
                                    Вы успешно справились со сценарием.
                                </p>
                                <div className="bg-blue-50 rounded-xl p-4 mb-8 border border-blue-100">
                                    <h4 className="font-medium text-blue-900 mb-2 text-sm uppercase tracking-wide">Обратная связь AI:</h4>
                                ...
                                <button
                                    ...
                                    className="w-full bg-blue-600 text-[#030213] py-3 rounded-xl font-medium hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200"
                                >
                                    Продолжить обучение
                                </button>
                            </div>
