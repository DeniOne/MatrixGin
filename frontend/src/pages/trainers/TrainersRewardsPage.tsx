...
const TrainersRewardsPage: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">Выплаты и Награды</h1>

            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-8 mb-8 border border-green-200">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="text-sm font-medium text-gray-500 mb-1">Ожидаемая выплата в декабре</h3>
                        <div className="text-3xl font-bold text-gray-900 mb-2">~48,000₽</div>
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-4">История выплат</h2>
            <div className="space-y-3">
                {payouts.map(payout => (
                    <div key={payout.id} className="bg-white p-5 rounded-xl border flex items-center justify-between">
                        <div>
                            <h3 className="font-bold text-gray-900">{payout.month}</h3>
