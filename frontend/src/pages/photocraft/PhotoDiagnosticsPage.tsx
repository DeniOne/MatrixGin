    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div>
                    <h1 className="text-3xl font-medium text-gray-900">Диагностика и Аудиты</h1>
                    <p className="text-[#717182] mt-1">Контроль качества работы фотографов и соблюдения стандартов</p>
                </div>
                <div className="mt-4 md:mt-0 flex space-x-3">
                    ...
                    <button className="flex items-center px-4 py-2 bg-indigo-600 text-[#030213] rounded-lg text-sm font-medium hover:bg-indigo-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-medium text-[#717182]">Средний балл (Качество)</h3>
                        <div className="p-2 bg-green-50 rounded-lg">
                            <CheckCircle className="w-5 h-5 text-green-600" />
                        </div>
                    </div>
                    <div className="flex items-baseline">
                        <span className="text-2xl font-medium text-gray-900">8.4</span>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-medium text-[#717182]">Ошибки (Критические)</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-medium text-[#717182]">NPS (Клиенты)</h3>
                        <div className="p-2 bg-blue-50 rounded-lg">
                            <PieChart className="w-5 h-5 text-blue-600" />
                        </div>
                    </div>
                    <div className="flex items-baseline">
                        <span className="text-2xl font-medium text-gray-900">72%</span>
                        <span className="ml-2 text-sm font-medium text-green-600 flex items-center">
                            <TrendingUp className="w-3 h-3 mr-1" />
                            +5%
                        </span>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-medium text-[#717182]">Проведено аудитов</h3>
                        <div className="p-2 bg-purple-50 rounded-lg">
                            <BarChart2 className="w-5 h-5 text-purple-600" />
                        </div>
                    </div>
                    <div className="flex items-baseline">
                        <span className="text-2xl font-medium text-gray-900">45</span>
                        <span className="ml-2 text-sm font-medium text-[#717182]">
                            за месяц
                        </span>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    <h2 className="font-medium text-gray-900">Последние аудиты</h2>
                    ...
                    <table className="w-full">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-[#717182] uppercase tracking-wider">Фотограф</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-[#717182] uppercase tracking-wider">Аудитор</th>
                                <th className="px-6 py-3 text-center text-xs font-medium text-[#717182] uppercase tracking-wider">Оценка</th>
                                <th className="px-6 py-3 text-center text-xs font-medium text-[#717182] uppercase tracking-wider">Статус</th>
