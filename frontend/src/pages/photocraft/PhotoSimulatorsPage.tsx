...
const PhotoSimulatorsPage: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8">
                <h1 className="text-3xl font-medium text-gray-900">Симуляторы ситуаций</h1>
                <p className="text-[#717182] mt-1">Тренируйте навыки общения с клиентами в безопасной среде</p>
            </div>
            ...
            {activeScenario ? (
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden max-w-4xl mx-auto">
                    <div className="bg-white px-6 py-4 flex justify-between items-center">
                        <h2 className="text-[#030213] font-medium text-lg">Сценарий: Капризный ребенок</h2>
                        <button
                            onClick={() => { setActiveScenario(null); setStep(0); }}
                            className="text-[#717182] hover:text-[#030213]"
                        >
                        ...
                        <div key={scenario.id} className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col">
                            <div className="h-48 overflow-hidden relative">
                                ...
                                <div className="absolute top-3 right-3">
                                    <span className={`px-3 py-1 rounded-full text-xs font-medium text-[#030213] uppercase tracking-wide ${scenario.difficulty === 'easy' ? 'bg-green-500' :
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                <div className="flex justify-between items-start mb-2">
                                    <h3 className="font-medium text-lg text-gray-900">{scenario.title}</h3>
                                </div>
                                <p className="text-[#717182] text-sm mb-4 flex-1">{scenario.description}</p>
                                ...
                                <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                                    ...
                                    {scenario.completed ? (
                                        ...
                                        <button
                                            ...
                                            className="bg-indigo-600 text-[#030213] px-4 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors flex items-center"
                                        >
