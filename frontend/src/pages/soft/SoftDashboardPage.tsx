    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Soft Skills & Развитие</h1>
                    <p className="text-gray-500 mt-1">Развивайте навыки, которые помогут вам расти профессионально и лично</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/personal/practices')}>
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mb-1">Стрик практики</h3>
                    <p className="text-sm text-gray-500">Вы выполняете задания 5 дней подряд! Так держать!</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/personal/badges')}>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-medium text-gray-500">Всего 12</span>
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-1">Мои достижения</h3>
                    <p className="text-sm text-gray-500">Последнее: "Мастер эмпатии"</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/personal/library')}>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-medium text-gray-500">Новое</span>
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-1">Библиотека</h3>
                    <p className="text-sm text-gray-500">Добавлено 3 новые книги по лидерству</p>
                </div>
            </div>
                        ...
                        <div key={course.id} className="bg-white rounded-xl border border-gray-200 p-4 flex space-x-4 hover:shadow-md transition-shadow">
                            ...
                            <div className="flex-1 flex flex-col justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">Следующий урок: {course.nextLesson}</p>
                                </div>
                                <div>
                    ...
                    {recommendations.map(course => (
                        <div key={course.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow group">
                            <div className="h-48 bg-gray-100 relative overflow-hidden">
                                ...
                                <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-md text-xs font-bold flex items-center shadow-sm">
                            ...
                            <div className="p-5">
                                ...
                                <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 h-12">{course.title}</h3>
