...
const SoftAssessmentPage: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900">Оценка и Тестирование</h1>
                <p className="text-gray-500 mt-1">Познайте себя лучше, чтобы эффективно развиваться</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-gray-900">Мой EQ Профиль</h3>
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-gray-900">Сильные стороны</h3>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-bold text-green-600">8.0/10</span>
                        </div>
                        <div className="w-full bg-gray-100 rounded-full h-1.5">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-gray-900">Зоны роста</h3>
                        <Target className="w-5 h-5 text-orange-500" />
                    </div>
                    <div className="space-y-3">
                        <div className="flex items-center justify-between text-sm">
                            <span>Публичные выступления</span>
                            <span className="font-bold text-orange-600">4.5/10</span>
                        </div>
                        <div className="w-full bg-gray-100 rounded-full h-1.5">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-bold text-orange-600">5.2/10</span>
                        </div>
                        <div className="w-full bg-gray-100 rounded-full h-1.5">
            ...
            {/* Assessments List */}
            <h2 className="text-xl font-bold text-gray-900 mb-6">Доступные тесты</h2>
                ...
                {assessments.map(test => (
                    <div key={test.id} className={`bg-white rounded-xl border p-6 flex flex-col ${test.status === 'locked' ? 'border-gray-200 opacity-70' :
                        ...
                        <div className="flex justify-between items-start mb-4">
                            ...
                            {test.status === 'locked' && <Lock className="w-5 h-5 text-gray-400" />}
                        </div>

                        <h3 className="text-lg font-bold text-gray-900 mb-2">{test.title}</h3>
                        <p className="text-sm text-gray-500 mb-6 flex-1">{test.description}</p>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            {test.status === 'available' && (
                                <button className="flex items-center text-sm font-bold text-indigo-600 hover:text-indigo-800">
