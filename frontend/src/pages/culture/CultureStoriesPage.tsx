    ...
    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-medium text-gray-900">Истории Успеха</h1>
                    ...
                    <div key={story.id} className="bg-white p-6 rounded-xl border border-gray-200">
                        <div className="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-[#717182]">{story.role}</div>
                            </div>
                        </div>
                        <p className="text-gray-700 mb-4">{story.text}</p>
                        <div className="flex items-center space-x-6 text-[#717182] text-sm">
