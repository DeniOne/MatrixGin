    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <h2 className="text-xl font-medium text-slate-900 mb-2">Ошибка загрузки обучения</h2>
                <p className="text-[#717182] mb-6">Не удалось связаться с сервером университета.</p>
                <Link to="/university" className="text-indigo-600 font-medium hover:underline flex items-center gap-2">
                    <ArrowLeft size={16} />
            ...
            <div className="bg-white border-b border-slate-200 pt-10 pb-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <div className="flex items-center gap-2 text-indigo-600 font-medium text-xs uppercase tracking-widest mb-3">
                                <GraduationCap size={16} />
                                Личный кабинет обучения
                            </div>
                            <h1 className="text-4xl font-medium text-slate-900 tracking-tight">Моё обучение</h1>
                            <p className="text-[#717182] mt-2 max-w-xl">
                        ...
                        <Link
                            to="/university"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-[#030213] rounded-2xl font-medium text-sm hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100"
                        >
                            <Compass size={18} />
                            Найти новые курсы
                        </Link>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6">
                <div className="grid grid-cols-1 gap-10">
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-8 md:p-10">
                            <div className="flex items-center justify-between mb-8">
                                <h2 className="text-2xl font-medium text-slate-900 tracking-tight">В процессе обучения</h2>
                                <span className="bg-indigo-50 text-indigo-700 px-3 py-1 rounded-lg text-xs font-medium">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-3xl p-8 text-[#030213] shadow-lg shadow-indigo-100">
                            <Trophy className="mb-4 opacity-80" size={32} />
                            <div className="text-3xl font-medium mb-1">{completedEnrollments.length}</div>
                            <div className="text-xs font-medium uppercase tracking-wider opacity-80 text-blue-50">Курсов завершено</div>
                        </div>
                    </div>
