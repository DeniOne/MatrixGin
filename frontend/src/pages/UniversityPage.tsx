...
export const UniversityPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC]">
            {/* Premium Header */}
            <div className="bg-white relative overflow-hidden py-16 border-b border-white/5">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            ...
                            <h1 className="text-4xl md:text-5xl font-medium text-[#030213] mb-4 tracking-tight">
                                Корпоративный <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400">Университет</span>
                            </h1>
                            <p className="text-lg text-[#717182] max-w-2xl leading-relaxed">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex gap-4">
                                <div className="bg-white/5 backdrop-blur-sm border border-black/10 p-4 rounded-2xl min-w-[120px]">
                                    <div className="text-2xl font-medium text-[#030213]">{academies.length || 0}</div>
                                    <div className="text-[10px] font-medium text-[#717182] uppercase tracking-widest">Академий</div>
                                </div>
                                <div className="bg-white/5 backdrop-blur-sm border border-black/10 p-4 rounded-2xl min-w-[120px]">
                                    <div className="text-2xl font-medium text-[#030213]">{activeEnrollments.length}</div>
                                    <div className="text-[10px] font-medium text-[#717182] uppercase tracking-widest">В процессе</div>
                                </div>
                            </div>
                            ...
                            {isTrainer ? (
                                <Link
                                    ...
                                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-900 font-medium text-sm transition-all shadow-lg shadow-amber-500/20"
                                >
                                    <ShieldCheck size={18} />
                                    Дашборд Тренера
                                </Link>
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/20 border border-black/10 text-[#030213] font-medium text-sm transition-all backdrop-blur-sm"
                                >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex gap-8">
                        <button
                            ...
                            className={`flex items-center gap-2 py-5 px-1 border-b-2 font-medium text-sm transition-all ${viewMode === 'academies'
                                ? 'border-indigo-600 text-indigo-600'
                                : 'border-transparent text-[#717182] hover:text-slate-800'
                                }`}
                        >
                            <LayoutGrid size={18} />
                            Академии
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 py-5 px-1 border-b-2 font-medium text-sm transition-all ${viewMode === 'catalog'
                                ? 'border-indigo-600 text-indigo-600'
                                : 'border-transparent text-[#717182] hover:text-slate-800'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 py-5 px-1 border-b-2 font-medium text-sm transition-all ${viewMode === 'my-courses'
                                ? 'border-indigo-600 text-indigo-600'
                                : 'border-transparent text-[#717182] hover:text-slate-800'
                                }`}
                        >
                            ...
                            {activeEnrollments.length > 0 && (
                                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-indigo-600 text-[10px] font-medium text-[#030213]">
                    ...
                    <>
                        ...
                        {viewMode === 'academies' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="flex items-end justify-between">
                                    <h2 className="text-2xl font-medium text-slate-900 tracking-tight">Образовательные центры</h2>
                                    <span className="text-sm font-medium text-[#717182]">Всего центров: {academies.length}</span>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {viewMode === 'catalog' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="flex items-end justify-between">
                                    <div>
                                        <h2 className="text-2xl font-medium text-slate-900 tracking-tight">Доступные курсы</h2>
                                        <p className="text-[#717182] text-sm mt-1">Курсы подобраны согласно вашей текущей квалификации</p>
                                    </div>
                                    <span className="text-sm font-medium text-[#717182]">Найдено: {availableCourses.length}</span>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {viewMode === 'my-courses' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="flex items-end justify-between">
                                    <h2 className="text-2xl font-medium text-slate-900 tracking-tight">Твоё обучение</h2>
                                </div>
