        ...
        <div className="p-8 space-y-8 max-w-7xl mx-auto">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                    <h2 className="text-xl font-medium text-gray-200 border-b border-black/10 pb-2">Системные Агрегаты</h2>
                    ...
                    <div className="bg-white/40 border border-black/10 rounded-2xl p-6">
                        <h3 className="text-sm font-medium text-[#717182] uppercase mb-6 tracking-widest">Макро-тренды (Система)</h3>
                        <div className="h-48 flex items-center justify-center border border-dashed border-black/10 rounded-xl">
                ...
                <div className="space-y-6">
                    <h2 className="text-xl font-medium text-gray-200 border-b border-black/10 pb-2">Структурный Разрез</h2>
                    ...
                    <div className="p-4 bg-indigo-500/5 border border-indigo-500/10 rounded-xl mt-8">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-medium text-indigo-400 uppercase">Privacy Guard Active</span>
                        </div>
                        <p className="text-[10px] text-[#717182] leading-relaxed italic">
...
const ExecutiveStatCard: React.FC<{ title: string; value: string; hint: string }> = ({ title, value, hint }) => (
    <div className="bg-white border border-black/10 rounded-xl p-5 hover:border-indigo-500/30 transition-colors">
...
const DepartmentActivityRow: React.FC<{ name: string; value: number }> = ({ name, value }) => (
    <div className="p-4 bg-white border border-black/10 rounded-lg flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
            ...
            <span className="text-xs font-medium text-indigo-400">{value}%</span>
        </div>
    </div>
);
