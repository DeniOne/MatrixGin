/**
 * ⚠️ GENERATED CONTRACT — DO NOT EXTEND LOCALLY
 * 
 * These types MUST be kept in sync with backend:
 * @see backend/src/entity-cards/entity-card.types.ts
 * 
 * Any extension MUST go through Registry bootstrap first.
 * Frontend types are a READ-ONLY projection.
 */
...
export type EntityFormMode = 'create' | 'read' | 'update';
