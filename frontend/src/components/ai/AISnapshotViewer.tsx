    ...
    return (
        <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden mt-6">
            <div className="bg-gray-800/50 px-4 py-3 border-b border-gray-800 flex items-center justify-between">
                ...
                <span className="text-[9px] text-gray-500 italic">Анонимизированный вид</span>
            </div>

            <div className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 bg-black/20 rounded-xl border border-gray-800/30">
                        <div className="text-[9px] text-gray-500 uppercase font-black mb-1">Узлы графа</div>
                        <div className="text-sm font-bold text-gray-200">{data.nodes?.length || 0} Сущности</div>
                    </div>
                    <div className="p-3 bg-black/20 rounded-xl border border-gray-800/30">
                        <div className="text-[9px] text-gray-500 uppercase font-black mb-1">Векторы влияния</div>
                        <div className="text-sm font-bold text-gray-200">{data.impacts?.length || 0} Группы анализа</div>
                    </div>
                </div>

                <div className="space-y-2">
                    <h5 className="text-[9px] text-gray-500 uppercase font-black px-1">Активные правила</h5>
