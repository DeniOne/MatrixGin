        ...
        <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl max-h-[80vh] flex flex-col">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-700">
                    <h2 className="text-2xl font-medium text-[#030213]">История транзакций</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 border-b border-gray-700 flex gap-4">
                    <div>
                        <label className="block text-sm font-medium text-[#717182] mb-2">
                            Тип
                        </label>
                        <select
                            value={filters.type || ''}
                            onChange={(e) => setFilters({ ...filters, type: e.target.value as TransactionType || undefined })}
                            className="px-3 py-2 bg-white border border-gray-700 rounded-md text-[#030213] text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        >
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    {isLoading ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-[#717182]">Транзакции не найдены</p>
                        </div>
                    ) : (
                        <div className="space-y-3">
                            {data.data.map((transaction) => (
                                <div
                                    key={transaction.id}
                                    className="flex items-center justify-between p-4 bg-white rounded-lg hover:bg-gray-850 transition-colors"
                                >
                                    <div className="flex items-center gap-4">
                                        {getTransactionIcon(transaction)}
                                        <div>
                                            <div className="font-medium text-[#030213]">
                                    ...
                                    <div className={`text-lg font-medium ${getTransactionColor(transaction)}`}>
                    ...
                    <div className="p-6 border-t border-gray-700 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="px-4 py-2 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed text-[#030213] rounded-md transition-colors"
                            >
                                Назад
                            </button>
                            <button
