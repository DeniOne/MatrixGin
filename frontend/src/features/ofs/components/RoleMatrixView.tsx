    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-medium text-gray-900">Матрица Ролей (МДР)</h2>
            ...
            <div className="flex gap-4 bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex-1 relative">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[#717182] w-5 h-5" />
                    <input
                        type="text"
                ...
                {filteredRoles.map(role => (
                    <div key={role.id} className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 className="font-medium text-lg text-gray-900">{role.role_name}</h3>
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="p-1 text-[#717182] hover:text-blue-600"
                                >
                                    <Edit2 className="w-4 h-4" />
                                </button>
                                <button
                                    onClick={() => handleDelete(role.id)}
                                    className="p-1 text-[#717182] hover:text-red-600"
                                >
        ...
        <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white z-10">
                    ...
                    <button onClick={onClose} className="text-[#717182] hover:text-gray-700">✕</button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button
                            type="submit"
                            className="px-4 py-2 bg-blue-600 text-[#030213] rounded-lg hover:bg-blue-700"
                        >
