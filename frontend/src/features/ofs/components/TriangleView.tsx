    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-8">
        <div className="max-w-3xl mx-auto">
          <svg viewBox="0 0 400 350" className="w-full">
            ...
            <g>
              ...
              <foreignObject x="140" y="10" width="120" height="80">
                <div className="flex flex-col items-center justify-center h-full text-[#030213] text-center">
                  <Camera className="w-6 h-6 mb-1" />
                  <span className="text-xs font-medium">Фотографы</span>
                </div>
              </foreignObject>
            </g>
            ...
            <g>
              ...
              <foreignObject x="-10" y="260" width="120" height="80">
                <div className="flex flex-col items-center justify-center h-full text-[#030213] text-center">
                  ...
                  <span className="text-xs font-medium">Дизайнеры</span>
                </div>
              </foreignObject>
            </g>
            ...
            <g>
              ...
              <foreignObject x="290" y="260" width="120" height="80">
                <div className="flex flex-col items-center justify-center h-full text-[#030213] text-center">
                  ...
                  <span className="text-xs font-medium">Продавцы</span>
                </div>
              </foreignObject>
            </g>
          </svg>
          ...
          <div className="text-center mt-6 text-sm text-gray-600">
            <p className="font-medium">Эффективность = Скорость потока × Качество × (1 - Потери)</p>
      ...
      {stats && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="font-medium text-gray-900 mb-4">Статистика по ролям</h3>
              ...
              return (
                <div key={role.triangle_role} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-3">
                    <div className={`w-10 h-10 ${config.color} rounded-lg flex items-center justify-center text-[#030213]`}>
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{role.total_employees}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Основная роль:</span>
                      <span className="font-medium">{role.primary_role_count}</span>
                    </div>
                  </div>
                </div>
              );
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 text-center">
            ...
            <span className="ml-2 text-xl font-medium text-gray-900">{stats.total_in_triangle}</span>
          </div>
        </div>
      )}
    </div>
