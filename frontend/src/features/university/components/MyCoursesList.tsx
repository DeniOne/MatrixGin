    ...
    if (enrollments.length === 0) {
        return (
            <div className="text-center py-12 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">У тебя пока нет активных курсов</h3>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-6">
                        ...
                        <div className="flex items-center justify-between md:justify-end gap-6 md:w-32">
                            <div className="flex flex-col items-end">
                                <span className="text-[10px] font-bold text-gray-400 uppercase">Последняя активность</span>
                                <span className="text-xs text-gray-600">
                                    {new Date(enrollment.enrolledAt).toLocaleDateString()}
                                </span>
                            </div>
                            <div className="p-2 rounded-xl bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all transform group-hover:scale-110">
                                <PlayCircle size={20} />
                            </div>
                        </div>
                    </div>
